...
const App = () => {
  ...
  <p>
    Howdy! My name is Dario Dias and I'm a <b style={{ color: "silver" }}>Dallas, TX</b> based computer science student at the{" "}
    <b style={{ color: "silver" }}>University of North Texas</b>. I love working with technology and I'm interested in{" "}
    <b style={{ color: "silver" }}>IT</b>. In my free time I love to listen to music, play video games, and take pictures!
  </p>
</section>
